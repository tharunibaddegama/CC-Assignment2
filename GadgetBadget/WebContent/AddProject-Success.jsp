        ...
        <div class="container" style="margin-top: 46px;">
            <div class="row">
                ...
                <div class="col-md-4 col-lg-8">
                    <div class="bs-callout bs-callout-success"><img src="assets\assets_hashi/img/suc.pmg.png" style="height: 100px;">
                        <h4>Your Project is Submitted Successfully!</h4>
                        <div class="m-5"><button class="btn btn-success ribbon" type="button"><a href="ViewAllProjects.jsp">View All Details</a></button></div>
                    </div>
                </div>
            </div>
        </div>
